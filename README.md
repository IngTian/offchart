...
Six boards, each answering one question:
...
- it is **negative** about as often as positive (822 neg / 312 pos in
  `legacy_fut`). A missing non-negative spread could only push it *positive*.
- it never leaves `-4..+4`, across markets spanning 724 to **25,702,684**
...
market-weeks and on **52.6%** of supplemental rows. The previous version showed a
...
percentiles are computed within a segment.
